...
<?php require('../../connect/connect.php');
  $SQL = "SELECT * FROM repair where UseFlag !=0";
  $stmt = $con->query($SQL);
  $i = 0;
  ?>
  <meta charset="utf-8">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">ซ่อมบำรุง</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p>แสดงข้อมูลของผู้เช่าที่จองบริการซ่อมบำรุง เช่น หลอดไฟเสีย อื่นๆ </p>
              ...
              <table class="table datatable">
                ...
                <?php
                  ...
                  <tr>
                      ...
                      <td><div align="center"><?php echo $repair_details ?></div></td>
