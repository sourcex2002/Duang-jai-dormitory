...
<?php require('../../connect/connect.php');
  $SQL = "SELECT * FROM clean where UseFlag !=0";
  $stmt = $con->query($SQL);
  $i = 0;
  ?>
  <meta charset="utf-8">
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " data-bs-target="#service-nav" data-bs-toggle="collapse" href="#">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">บริการ</li>
          <li class="breadcrumb-item active">ทำความสะอาด</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <h5 class="card-title">ทำความสะอาด</h5>
              <p>แสดงข้อมูลของผู้เช่า ที่ต้องการใช้บริการทำความสะอาดห้องพักของตนเอง </p>
              ...
              <table class="table datatable">
                ...
                <tr>
                  ...
                  <th> <div align="center">วันที่ดำเนินการ</div></th>
                ...
                <?php
                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                $clean_details= $row["clean_details"];
                                $useflag =$row["useflag"];
                  ...
                  <tr>
                      ...
                      <td><div align="center"><?php echo $clean_details ?></div></td>
