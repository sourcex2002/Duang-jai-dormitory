...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " data-bs-target="#info-nav" data-bs-toggle="collapse" href="#">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p>แสดงข้อมูลของผู้เช่า ณ ปัจจุบัน </p>
              ...
              <thead>
                ...
                <?php
                  ...
                  <tr>
                      ...
                      <td><div align="center"><?php echo $address_mem ?></div></td>
                      <td><div align="center"><?php echo $tel ?></div></td>
                      <td><div align="center"><?php echo $cardID ?></div></td>
