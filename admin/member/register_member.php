    ...
    <div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">สมัครสมาชิกผู้เช่า</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
  </main><!-- End #main -->
  ...
  <main id="main" class="main">
    <section class="section">
      <div class="row">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">สมัครสมาชิกผู้เช่า</h5>

              <!-- Multi Columns Form -->
              <form class="row g-3" action="member_pcs.php" method="post">
                <div class="col-md-6">
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" id="address_mem" name="address_mem">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <label for="inputCity" class="form-label">รหัสบัตรประชาชน</label>
                  <input type="text" class="form-control" id="cardID" name="cardID">
                </div>
                <div class="col-md-6">
                <label for="build" class="form-label">ตึก</label>
                ...
                <div class="col-md-6">
                  <label for="inputAddress2" class="form-label">เลขห้อง</label>
