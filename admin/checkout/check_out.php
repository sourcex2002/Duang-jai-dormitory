...
<?php require('../../connect/connect.php');
  $SQL = "SELECT * FROM checkout_notify ";
  $stmt = $con->query($SQL);
  $i = 0;
  ?>
  <meta charset="utf-8">
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " data-bs-target="#checkout-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>คืนห้องพัก</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="checkout-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="../checkout/check_out.php">
              <i class="bi bi-circle"></i><span>ตารางแจ้งออก</span>
            </a>
          </li>
          <li>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">คืนห้องพัก</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">คืนห้องพัก</h5>
              <p>แสดงข้อมูลของผู้เช่าที่ต้องการคืนห้องพัก </p>
              ...
              <thead>
                  ...
                  <th> <div align="center">ตึก</div></th>
                  <th> <div align="center">เลขห้อง</div></th>
                  <th> <div align="center">วันที่แจ้ง</div></th>
                  <th> <div align="center">วันที่คืนห้อง</div></th>
                  </tr>
                </thead>
                <tbody>
                <?php
                  ...
                  <tr>
                      ...
                      <td><div align="center"><?php echo $firstname ?></div></td>
                      <td><div align="center"><?php echo $lastname ?></div></td>
                      <td><div align="center"><?php echo $build ?></div></td>
                      <td><div align="center"><?php echo $num_room ?></div></td>
                      <td><div align="center"><?php echo $processing_date ?></div></td>
                      <td><div align="center"><?php echo $checkout_date ?></div></td>
                      <td><div align="center"><button type="button" class="btn btn-primary" >แก้ไข</button></div></td>
