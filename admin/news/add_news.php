...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " data-bs-target="#news-nav" data-bs-toggle="collapse" href="#">
      ...
      <div class="row">
        <div class="card">
          <div class="card-body">
            ...
            <!-- Multi Columns Form -->
            <form action="news_pcs.php" method="post">
              <div class="row">
                <div class="col-md-6">
                  <label class="form-label">วันที่ดำเนินการ</label>
                  <div class="input-group-addon"><i class="icon-calendar"></i></div>
                  <input class="form-control input-lg" id="processing_date" type="date" name="processing_date"
                    placeholder="dd/mm/yyyy" required="" />
                </div>
                <div class="col-md-6">
                  <label for="useflage" class="form-label">สถานะ</label>
                  <input type="text" class="form-control" id="useflag" name="useflag">
                </div>
              </div>

              <div class="col-12">
                <label class="form-label">หัวข้อ</label>
                <input type="text" class="form-control" id="N_header" name="N_header">
              </div>
              <div class="col-md-12">
                <label class="form-label">รายละเอียด</label>
                <textarea class="form-control" id="N_information" name="N_information"></textarea>
              </div>
              <br>
