...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="../rentroom/rentroom.php">
          <i class="bi bi-grid"></i>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="../checkout/../checkout/check_out.php">
          <i class="bi bi-grid"></i>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="../payment/../payment/invoice.php">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">จองห้องพัก</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">จองห้องพัก</h5>
              <p>แสดงข้อมูลของผู้เช่า ที่ต้องการจองห้องเพิ่ม </p>
              ...
              <thead>
                  ...
                  <th> <div align="center">วันที่ย้ายเข้า</div></th>
                ...
                <?php
                  ...
                  <tr>
                      ...
                      <td><div align="center"><?php echo $tel ?></div></td>
                      <td><div align="center"><?php echo $processing_date ?></div></td>
                      <td><div align="center"><?php echo $checkin_date ?></div></td>
