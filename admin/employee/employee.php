        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p>แสดงข้อมูลพนักงาน ณ ปัจจุบัน </p>
              ...
              <thead>
                ...
                <?php
                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                $position_emp = $row["position_emp"];
                                $tel_emp = $row["tel_emp"];
                                $cardID_emp = $row["cardID_emp"];
                                $address_emp = $row["address_emp"];
                  ...
                  <tr>
                      ...
                      <td><div align="center"><?php echo $firstname_emp ?></div></td>
                      <td><div align="center"><?php echo $lastname_emp ?></div></td>
                      <td><div align="center"><?php echo $position_emp ?></div></td>
                      <td><div align="center"><?php echo $tel_emp ?></div></td>
                      <td><div align="center"><?php echo $cardID_emp ?></div></td>
                      <td><div align="center"><?php echo $address_emp ?></div></td>
