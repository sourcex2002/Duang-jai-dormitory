...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="../payment/invoice.php">
          <i class="bi bi-grid "></i>
    ...
    <div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">ทำใบแจ้งหนี้</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
  </main><!-- End #main -->
      ...
      <div class="row">
        <div class="card">
          <div class="card-body">
            ...
            <form class="row g-3">
              <div class="col-md-6">
                <label for="inputEmail5" class="form-label">รหัสใบแจ้งหนี้</label>
                <input type="email" class="form-control" id="inputEmail5">
              </div>
              <div class="col-md-6">
                <label for="inputAddress5" class="form-label">วันที่ดำเนินการ</label>
                <input class="form-control input-lg" id="date1" type="date" name="date1" placeholder="dd/mm/yyyy" required="" />
              </div>

              <div class="col-md-6">
                <label for="inputState" class="form-label">ตึก</label>
                <select id="inputState" class="form-select">
                  <option selected>กรุณาเลือกตึก</option>
                  <option>ตึก ก</option>
                </select>
              </div>
              
              <div class="col-md-6">
                <label for="inputPassword5" class="form-label">เลขห้อง</label>
                <input type="text" class="form-control" id="input">
              </div>
              <div class="col-12">
                <label for="inputPassword5" class="form-label">ค่าห้อง</label>
                <input type="text" class="form-control" id="input">
              </div>
              <div class="col-md-6">
                <label for="inputPassword5" class="form-label">ชื่อ</label>
                <input type="text" class="form-control" id="input">
              </div>
              <div class="col-md-6">
                <label for="inputPassword5" class="form-label">นามสกุล</label>
                <input type="text" class="form-control" id="input">
              </div>
              <div class="col-md-6">
                <label for="inputPassword5" class="form-label">มิเตอร์ไฟเก่า</label>
                <input type="text" class="form-control" id="input">
              </div>
              <div class="col-md-6">
                <label for="inputPassword5" class="form-label">มิเตอร์ไฟใหม่</label>
                <input type="text" class="form-control" id="input">
              </div>
              <div class="col-12">
                <label for="inputAddress5" class="form-label">ค่าไฟ ราคา/หน่วย</label>
                <input type="text" class="form-control" id="inputAddres5s" >
              </div>
              <div class="col-md-6">
                <label for="inputPassword5" class="form-label">มิเตอร์น้ำเก่า</label>
                <input type="text" class="form-control" id="input">
              </div>
              <div class="col-md-6">
                <label for="inputPassword5" class="form-label">มิเตอร์น้ำใหม่</label>
                <input type="text" class="form-control" id="input">
              </div>
              <div class="col-12">
                <label for="inputAddress5" class="form-label">ค่าน้ำ ราคา/หน่วย</label>
                <input type="text" class="form-control" id="inputAddres5s" >
              </div>
              <div class="col-md-6">
                <label for="inputState" class="form-label">สถานะการชำระเงิน</label>
                <select id="inputState" class="form-select">
                  <option selected>กรุณาเลือกสถานะการชำระเงิน</option>
                  <option>ชำระเงินแล้ว</option>
                </select>
              </div>
              <div class="col-md-6">
                <label for="inputZip" class="form-label">ยอดรวม</label>
