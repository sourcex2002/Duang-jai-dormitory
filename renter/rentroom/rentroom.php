            ...
            <div class="row">
              <div class="col-sm-6 mb-sm-40">
                ...
                <ul class="product-gallery">
                  <li><a class="gallery" href="../assets/images/room.jpg">
                      <img src="../assets/images/room.jpg" alt="Single Product  Image" /></a>
                  </li>
                  <li><a class="gallery" href="../assets/images/room2.jpg">
                      <img src="../assets/images/room2.jpg" alt="Single Product  Image" /></a>
                  </li>
                  <li><a class="gallery" href="../assets/images/room1.jpg">
                      <img src="../assets/images/bathroom.jpg" alt="Single Product  Image" /></a>
                  </li>
                  <li><a class="gallery" href="../assets/images/room3.jpg">
                      <img src="../assets/images/room3.jpg" alt="Single Product  Image" /></a>
                  </li>
                  <p>**ห้องทุกตึกมีลักษณะเดียวกัน**</p>
                </ul>
              </div>
              <div class="col-sm-6">
                <div class="row">
                  <div class="col-sm-12">
                    <h1 class="product-title font-alt">จองห้องพัก</h1>
                  </div>
                </div>
                ...
                <div class="row mb-20">
                  <div class="col-sm-12">
                    <div class="description">
                      <p>หอพักคุณภาพ ราคาประหยัด ขนาดห้อง : 25 ตร.ม.
                        เงินประกันล่วงหน้า : 1 เดือน
                        โปรโมชั่นสำหรับผู้เช่าทุกท่าน ไม่มีค่าล่วงหน้า พิเศษ ทำสัญญา 1 ปีฟรี 1เดือน (*ฟรีเดือนที่12
                        ของสัญญาเข้าพัก)
                      </p>
                      <p>
                        ประเภทห้องพัก
                        ห้องพักไม่มีเฟอร์นิเจอร์ ราคา 1200 บาท ต่อเดือน สัญญาเช่า 1 ปี **ฟรีที่จอดรถมอไซต์
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-sm-8 "><a class="btn btn-lg btn-block btn-round btn-b"
                    href="../rentroom/rentroom_form.php">จองห้อง</a></div>
